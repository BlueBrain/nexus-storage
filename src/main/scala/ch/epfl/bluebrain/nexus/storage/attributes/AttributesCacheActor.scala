...
/**
  ...
  */
class AttributesCacheActor[F[_]: Effect, S](computation: AttributesComputation[F, S])(
...
object AttributesCacheActor {
  ...
  private[attributes] sealed trait Protocol extends Product with Serializable
